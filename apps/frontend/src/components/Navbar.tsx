    ...
    <>
      <nav style={{
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", width: "100%" }}>
          ...
          {/* Desktop links */}
          <div style={{ display: "flex", alignItems: "center", gap: "2rem", position: "absolute", left: "50%", transform: "translateX(-50%)" }} className="nav-links">
            <Link href="/features/music-marketing" className="nav-link" style={{ color: "var(--text-secondary)", textDecoration: "none", fontSize: "0.9375rem", fontWeight: 500 }}>Features</Link>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
            <button
              ...
              style={{ display: "none", background: "none", border: "none", cursor: "pointer", color: "var(--text-secondary)", fontSize: "1.25rem", padding: "0.25rem" }}
            ...
            <Link href="/signup" style={{
              ...
              boxShadow: "0 4px 15px rgba(58,96,231,0.35)", whiteSpace: "nowrap",
            }}>
              Start for Free
            </Link>
          </div>
      ...
      {open && (
        <div style={{
          ...
          width: "calc(95% - 2rem)", background: "rgba(255,255,255,0.97)",
          backdropFilter: "blur(20px)", borderRadius: 16, padding: "1.25rem",
          boxShadow: "0 8px 32px rgba(0,0,0,0.12)", border: "1px solid var(--border)",
          zIndex: 49, display: "flex", flexDirection: "column", gap: "0.875rem",
        }}>
          {[
      ...
      <style jsx global>{`
        @media (max-width: 768px) {
          nav { width: calc(95% - 2rem) !important; padding: 0.5rem 1.5rem !important; }
