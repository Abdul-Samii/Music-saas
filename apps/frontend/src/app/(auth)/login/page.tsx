...
export default function LoginPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", background: "#fff", color: NAVY }}>
      ...
      <div style={{ display: "none", flex: 1, background: NAVY, position: "relative", overflow: "hidden", alignItems: "center", justifyContent: "center", padding: "3rem" }} className="login-left">
        ...
        <div style={{ position: "relative", textAlign: "center", maxWidth: 360 }}>
          ...
          <h2 style={{ fontSize: "1.75rem", fontWeight: 900, color: "#fff", marginBottom: "1rem", letterSpacing: "-0.02em" }}>Grow your music with data</h2>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
            {["$0.007 avg Cost per Stream", "1.2M+ streams generated", "500+ artists growing"].map((t) => (
      ...
      <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", padding: "2rem", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ width: "100%", maxWidth: 420, position: "relative" }}>
          ...
          <div style={{ textAlign: "center", marginBottom: "2.5rem" }}>
            ...
            <h1 style={{ fontSize: "1.6rem", fontWeight: 900, marginBottom: "0.5rem", letterSpacing: "-0.02em", color: NAVY }}>Welcome back</h1>
            <p style={{ color: "#4A5370", fontSize: "0.875rem" }}>Sign in to your account to continue</p>
          </div>
          ...
          <div style={{ background: "#fff", border: "1px solid #E2E6F0", borderRadius: 20, padding: "2rem", boxShadow: "0 4px 24px rgba(0,0,0,0.06)" }}>
            ...
            <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
              <div>
                ...
                <input id="email" type="email" required placeholder="you@email.com" value={email} onChange={(e) => setEmail(e.target.value)}
              ...
              <div>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "0.375rem" }}>
                  <label style={{ fontSize: "0.8rem", fontWeight: 600, color: NAVY }} htmlFor="password">Password</label>
                  <Link href="/forgot-password" style={{ fontSize: "0.75rem", color: BLUE, textDecoration: "none", fontWeight: 500 }}>Forgot password?</Link>
                </div>
          ...
          <p style={{ textAlign: "center", marginTop: "1.5rem", color: "#9BA3BF", fontSize: "0.875rem" }}>
            ...
            <Link href="/signup" style={{ color: BLUE, textDecoration: "none", fontWeight: 600 }}>Create one free</Link>
          </p>
        </div>
      </div>
