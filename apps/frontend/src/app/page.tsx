    ...
    <div style={{ minHeight: "100vh", background: "var(--bg)" }}>
      ...
      <section style={{ padding: "6rem 2rem 5rem", textAlign: "center", maxWidth: 900, margin: "0 auto", position: "relative" }}>
        <div style={{
          ...
          background: "radial-gradient(ellipse, rgba(58,96,231,0.12) 0%, transparent 70%)",
          pointerEvents: "none",
        }} />
          ...
          {[
            {
              ...
              color: "#3A60E7", title: "Campaign Builder",
            ...
            },
            {
              ...
              color: "#12B76A", title: "Cost per Stream Analytics",
            ...
            },
            {
              ...
              color: "#4C1AEA", title: "Lyric Video Creator",
            ...
            >
              ...
              <h3 style={{ fontWeight: 600, marginBottom: "0.75rem", fontSize: "1.05rem", color: "var(--text-primary)" }}>{f.title}</h3>
      ...
      <section style={{ padding: "5rem 2rem", background: "var(--bg-card)", borderTop: "1px solid var(--border)", borderBottom: "1px solid var(--border)" }}>
        <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center" }}>
          <h2 style={{ fontSize: "2rem", fontWeight: 700, marginBottom: "1rem", color: "var(--text-primary)" }}>
            From Upload to Growth in 4 Steps
          </h2>
            ...
            {[
              ...
              <div key={s.step} style={{ textAlign: "center" }}>
                <div style={{
                  ...
                  display: "flex", alignItems: "center", justifyContent: "center",
                  margin: "0 auto 1rem", fontSize: "0.875rem", fontWeight: 700,
                }}>{s.step}</div>
                <h4 style={{ fontWeight: 600, marginBottom: "0.5rem", fontSize: "0.95rem", color: "var(--text-primary)" }}>{s.title}</h4>
      ...
      <section id="pricing" style={{ padding: "5rem 2rem", maxWidth: 900, margin: "0 auto" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: "1.5rem" }}>
          {[
            { name: "Starter", price: "Free", period: "forever", features: ["3 campaigns/month", "Basic analytics", "1 lyric video/month", "Email support"], cta: "Get Started", primary: false },
            { name: "Pro", price: "$49", period: "/month", features: ["Unlimited campaigns", "Full analytics + CPS", "Unlimited lyric videos", "Priority support", "Meta Ads API access"], cta: "Start Free Trial", primary: true },
            { name: "Label", price: "$199", period: "/month", features: ["Everything in Pro", "Up to 20 artists", "White-label reports", "Dedicated account manager", "Custom integrations"], cta: "Contact Sales", primary: false },
          ].map((plan) => (
            <div key={plan.name} className="card" style={{
              position: "relative",
              border: plan.primary ? "1.5px solid var(--primary)" : "1px solid var(--border)",
              boxShadow: plan.primary ? "0 0 40px var(--primary-glow)" : undefined,
            }}>
              {plan.primary && (
                <div style={{
                  position: "absolute", top: -12, left: "50%", transform: "translateX(-50%)",
                  background: "var(--primary)", color: "#fff", fontSize: "0.7rem", fontWeight: 700,
      ...
      {/* ── Footer ── */}
      <footer style={{ padding: "2rem 2.5rem", borderTop: "1px solid var(--border)", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "1rem", background: "var(--bg-card)" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
          ...
          <span style={{ fontWeight: 600, fontSize: "0.875rem", color: "var(--text-primary)" }}>Escalium</span>
        </div>
