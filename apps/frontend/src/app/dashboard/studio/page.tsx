    ...
    <div className="animate-fade-in" style={{ maxWidth: 800, margin: "0 auto", display: "flex", flexDirection: "column", gap: "1.75rem" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
        <div>
          ...
          <p style={{ fontSize: "0.8125rem", color: "#64748b", marginTop: "0.25rem" }}>Upload your track, trim it, and prepare it for your lyric video</p>
        </div>
        <div style={{ display: "flex", gap: "0.5rem" }}>
          {["Audio", "Lyrics", "Sync", "Style", "Render"].map((s, i) => (
            <div key={s} style={{
              padding: "0.3rem 0.75rem", borderRadius: 99, fontSize: "0.72rem", fontWeight: 700,
              background: i === 0 ? BLUE : "#F1F5F9",
              color: i === 0 ? "#fff" : "#94a3b8",
              border: `1px solid ${i === 0 ? BLUE : "#E2E6F0"}`,
            }}>{s}</div>
          ))}
        </div>
      </div>
        ...
        <>
          ...
          <div style={{ display: "flex", justifyContent: "flex-end" }}>
            <button
              ...
              style={{
                display: "flex", alignItems: "center", gap: "0.5rem",
                padding: "0.875rem 2rem", borderRadius: 12, border: "none", cursor: overLimit ? "not-allowed" : "pointer",
                background: overLimit ? "#E2E6F0" : `linear-gradient(135deg, ${BLUE}, #4C1AEA)`,
                color: overLimit ? "#94a3b8" : "#fff", fontWeight: 700, fontSize: "0.9rem",
              }}
            >
              Continue to Lyrics
