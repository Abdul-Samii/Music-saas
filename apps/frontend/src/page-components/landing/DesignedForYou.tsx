          ...
          <div>
            <FadeInUp>
              <div className="mb-8 md:mb-12">
                <span className="sectionLabel mb-3">DESIGNED FOR YOU</span>
                  ...
                  <div key={c.title} className="flex gap-6">
                    ...
                    <div className="w-0 grow">
                      ...
                      <div className="text-sm">
                        <TextAnimation text={c.desc} staggerChildren={0.01} />
                      </div>
                    </div>
                  </div>
                ))}
            ...
            <div className="flex flex-col gap-2 sm:gap-4 justify-end">
              <FadeInUp>
                <Image
                  ...
                  src="/img/designed-for-you-1.webp"
                  alt=""
                />
              </FadeInUp>
              <FadeInUp>
                <div className="bg-primary text-white p-6 sm:p-8 rounded-2xl">
                  <h5 className="text-2xl font-italic mb-2">Scalable</h5>
            ...
            <div className="flex flex-col gap-2 sm:gap-4 justify-start">
              ...
              <FadeInUp>
                <Image
                  ...
                  height={700}
                  className="w-full rounded-2xl"
                  src="/img/designed-for-you-2.webp"
                  alt=""
                />
              </FadeInUp>
            </div>
