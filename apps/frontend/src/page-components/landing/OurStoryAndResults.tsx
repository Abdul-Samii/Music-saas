...
const data = [
	{
		...
		description: (
			<div>
				...
				<p>
					Our strategy is built around <u>high-volume creative testing</u>{" "}
					and consistent <u>budget management</u> to optimize cost per
					result (CPR).
				</p>
				<p>
					Across different clients budgets we started from a monthly ad
					spend of $27,000, and we successfully scaled campaigns to $45,000
					while <u>reducing costs by over 40%.</u>
				</p>
			</div>
		),
	},
		...
		description: (
			<ul className="grid grid-cols-1 list-disc gap-2 mb-6 pl-4">
				...
				<li>
					...
					highest revenue and segmenting them to achieve not only low CPR,
					but also a high volume of Spotify streams.
				</li>
			</ul>
		),
	},
			...
			<div>
				...
				<ul className="grid grid-cols-1 list-disc gap-2 mb-6 pl-4">
					<li>
						...
						achieving profitability, in this case was the{" "}
						<u>low volume of creatives and the poor management.</u>
					</li>
					<li>
						<b>Creative testing:</b> One of the problems the artists had,
						is that they didn’t have a creative system and they were
						running only 2-3 ads per week, which lead to high costs. When
						they started working with us, we created a full system that
						lead to creating a high volume of creatives every single month{" "}
						<u>(+300 ads/month) consistently</u>
					</li>
					<li>
						<b>Management:</b>&nbsp;We have someone watching and
						monitoring from monday to sunday at least 4 hours a day:
						campaigns costs, optimising budgets, turning off bad creatives
						and on new ones.
					</li>
				</ul>
			</div>
		...
		description: (
			<div>
				...
				<ul className="grid grid-cols-1 list-disc gap-2 mb-6 pl-4">
					...
					<li>
						<b>Results:</b>&nbsp;While increasing meta ads results by over
						300%
					</li>
					<li>
					...
					<li>
						<b>Spotify Monthly Listeners: </b>We added +5M Monthly
						Listeners to different artists.
					</li>
					<li>
						<b>TikTok: </b>We have generated over 20 million views across
						multiple TikTok accounts and videos, while making songs go
						viral and inspiring more than 2,000 videos using the same
						audio.
					</li>
				</ul>
