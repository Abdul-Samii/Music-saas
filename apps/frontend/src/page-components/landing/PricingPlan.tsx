        ...
        <FadeInUp>
          <div className="text-center mb-8 md:mb-16">
            ...
            <p className="md:text-lg">
              Start free. Pay only as you scale. A small commission on your ad
              spend — that&apos;s it.
            </p>
          </div>
        </FadeInUp>
  ...
  return (
    ...
    >
      ...
      <div className="text-3xl mb-8">
        <span className="font-bold">{annual ? plan.annual : plan.price}</span>{" "}
      ...
      <div className="mt-6 flex justify-center">
        <Link
          ...
          className={cn(
            ...
            {
              "bg-primary border-primary text-white font-bold": plan.featured,
            },
          )}
        >
          {plan.buttonText}
