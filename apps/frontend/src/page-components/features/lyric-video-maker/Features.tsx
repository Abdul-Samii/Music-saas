...
const Features = () => {
  ...
  return (
    <section className="relative z-10">
      {/* py-20 lg:py-30 */}
      <div className="container md:bg-bg md:rounded-xl md:px-10! md:py-10 md:shadow-[0_10px_60px_rgba(0,0,0,.05)] max-w-6xl mx-auto">
        <FadeInUp>
        ...
        <div className="grid grid-cols-12 gap-5 md:gap-12">
          ...
          <div className="col-span-12 md:col-span-5 order-2 md:order-1 grid grid-cols-1 gap-4.5">
            {targetAudience.map((item) => {
              ...
              return (
                ...
                >
                  <h3
                    className={cn("text-3xl lg:text-5xl font-bold text-muted", {
                  ...
                  {isActive && (
                    <motion.div
                      ...
                      viewport={{ once: true }}
                    >
                      <p className="leading-[1.2]">{item.description}</p>
                    </motion.div>
                  )}
                </div>
              );
