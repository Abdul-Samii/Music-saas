            ...
            <div className="max-w-[600px]">
              ...
              <div className="text-secondary">
                <p className="mb-4 max-w-[560px]">
                  we know you want to create music, create content, upload, go
                  viral, get streams. But creating the content is the hard part
                </p>
                ...
                <p className="mb-4">
                  This was built for artists, singers, producers and record
                  labels/managers.
                </p>
