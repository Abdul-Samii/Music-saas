        ...
        <FadeInUp>
          <div className="text-center mb-8 md:mb-12">
            ...
            <p className="text-secondary  max-w-[600px] mx-auto mb-4">
              Escalium is a Platform designed specifically for music. Most Lyric
              platforms aren’t build for artists, or simply aren’t designed to
              make your videos stand out and get the streams you should get.
            </p>
            <p className="text-secondary  max-w-[600px] mx-auto">
              You don’t need to know or have experience with video editing.
            </p>
          </div>
